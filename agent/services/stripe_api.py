...
def create_subscription(customer_id, plan, user):
    ...
    trial_period_days = {'trial_period_days': plan.trial_period_days} if plan.trial_period_days else {}
    is_trial = True if plan.trial_period_days else False

    expand = (
        {'expand': ['latest_invoice.payment_intent', 'pending_setup_intent']}
        if plan.trial_period_days
        else {'expand': ['latest_invoice.payment_intent']}
    )
